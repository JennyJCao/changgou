...
public class SpuController {
    ...
    public Result restore(@PathVariable("id") Long spuId) {
        ...
        return new Result(true, StatusCode.OK, "被逻辑删除的商品恢复成功");
    }
    ...
    public Result pullMany(@RequestBody Long[] ids) {
        ...
        return new Result(true, StatusCode.OK, "批量商品下架成功，本次下架数量为：" + count);
    }

    @PutMapping("/put/many")
    public Result putMany(@RequestBody Long[] ids) {
        int count = spuService.putMany(ids);
        return new Result(true, StatusCode.OK, "批量商品上架成功，本次上架数量为：" + count);
    }
